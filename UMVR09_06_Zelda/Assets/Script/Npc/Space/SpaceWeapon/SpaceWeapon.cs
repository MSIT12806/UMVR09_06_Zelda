...
public class SpaceWeapon : MonoBehaviour
{
    ...
    public void SmallBallAttack(Vector3 position)
    {
        ...
        smallBall.force = ObjectManager2.MainCharacter.position - this.transform.position;
    ...
    public void BigBallAttack(Vector3 position)
    {
        ...
        bigBall.force = ObjectManager2.MainCharacter.position - this.transform.position;
