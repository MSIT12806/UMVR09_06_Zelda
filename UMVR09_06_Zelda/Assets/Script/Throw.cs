...
public class Throw : MonoBehaviour
{
    ...
    public void ItemExplode(string Explode)  //物件效果（動作事件）
    {
        ...
        else if (Explode == "Obj_Ice")
        {
            ...
            NpcCommon.AttackDetection("Pico", itemEffect_pos, ItemEffect_obj.transform.forward, 360.0f, 1.0f, false, new DamageData(5, Vector3.zero, HitType.Heavy, new DamageStateInfo(DamageState.Ice, 3)), "Npc");
        }
